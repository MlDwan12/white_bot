...
export class DirectMessageRecipientsService {
  ...
  /**
   * Уникальные `PlatformUser`, участвовавшие в конкурсе из этой группы —
   * `ContestParticipant.groupId` намеренно, не групп у поста: рассылка не
   * привязана к тому, куда уходил конкретный анонс.
   *
